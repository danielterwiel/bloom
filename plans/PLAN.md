...
6. **Oxc tools**: `oxlint` for linting (oxfmt not yet stable — use Prettier or Biome for formatting)
...
└── biome.json                     # Biome for formatting (oxfmt alternative)
```
...
- [ ] Define semantic design tokens:
  ...
  @theme {
    ...
    --color-accent: oklch(0.60 0.15 45);       /* Terracotta */
    ...
    /* Shadows */
    --shadow-card: 0 2px 8px oklch(0.20 0.02 90 / 0.08);
...
@theme {
  ...
  --color-chart-3: oklch(0.60 0.15 45);   /* Terracotta */
  --color-chart-4: oklch(0.70 0.12 320);  /* Peony */
  --color-chart-5: oklch(0.65 0.10 280);  /* Lavender */
}
```
